...
#define rx D7
#define tx D6
String SOS_NUM = "+917904817218"; // Add a number on which you want to receive call or SMS

int SOS_Time = 4; // Press the button 5 sec
...
void setup()
{
  ...
  Serial1.begin(115200, SERIAL_8N1, rx, tx); // For A9G Board
...
// String lat = "11.110328";
//     String longi = "77.168757";    
